    ...
    <div class="box">
        <div class="box-body">
            ...
            <div class="form-group text-right">
                <button class="btn btn-success btn-sm" type="submit" :disabled="validateEntry">CREATE JOURNAL</button>
            </div>
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        created: function() {
            ...
            this.amount = this.items.amount ? this.items.amount : 0;
            this.disableAmount = this.items.amount ? true : false;
