        ...
        <form :action="formUrl" method="post">
            ...
            <div class="col-md-12">
                <div class="form-group text-right">
                    <button class="btn btn-sm btn-success">CREATE PURCHASE</button>
                </div>
            </div>
        </form>
    ...
    export default {
        ...
        methods: {
            ...
            getPurchaseOrderData(){
                ...
                var app = this;
                axios.get(app.apiUrl)
                    .then(response => {
                        app.otherMaterialItems = response.data.om ? response.data.om : [];
                        app.rawMaterialItems = response.data.rm ? response.data.rm : [];
                        app.logItems = response.data.l ? response.data.l : [];
                        app.selectVendor(response.data.v);
                    });
            }
        ...
        created: function() {
            ...
            this.items.v ? this.selectVendor(this.items.v) : '';
